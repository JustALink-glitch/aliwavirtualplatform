  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-2xl space-y-6 font-[Manrope]">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-[10px] font-black text-gray-700 tracking-wider mb-1">YEARS OF EXPERIENCE</label>
      ...
      <div>
        <label className="block text-[10px] font-black text-gray-700 tracking-wider mb-1">AREA OF EXPERTISE</label>
        <input name="expertise" value={form.expertise} onChange={handle} placeholder="e.g. Data Analytics, UX Design"
          className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs outline-none focus:border-[#2563EB] text-gray-700 font-semibold" />
      </div>
...
function SecurityTab() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSubmitting(true)
      // Call standard reset/set password api
