...
import { LayoutDashboard, Users, BookOpen, UserCheck, GraduationCap, BarChart2, Settings, LogOut, X } from 'lucide-react'

const navItems = [
  { icon: LayoutDashboard, label: 'Dashboard', path: '/admin/dashboard' },
  { icon: Users, label: 'Cohorts', path: '/admin/cohorts' },
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="px-2 py-4 border-t border-gray-100">
          <div onClick={() => setShowLogout(true)}
            ...
            <div className="w-8 h-8 rounded-full bg-[#2563EB] flex items-center justify-center text-white text-xs font-bold flex-shrink-0">AF</div>
            {(!collapsed || isMobile) && (
              <>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-800 truncate">Admin User</p>
                  <p className="text-xs text-gray-400 truncate">admin@training.com</p>
                </div>
...
export default function Sidebar({ collapsed, activePath }) {
